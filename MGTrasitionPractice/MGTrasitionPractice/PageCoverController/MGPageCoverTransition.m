...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    switch (_type) {
        case MGPageCoverTransitionTypePush:
            [self doPushAnimation:transitionContext];
            break;
            
        case MGPageCoverTransitionTypePop:
