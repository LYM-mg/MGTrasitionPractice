...
@interface MGPresentOneTransition ()

@property (nonatomic, assign) MGPresentOneTransitionType type;

@end

@implementation MGPresentOneTransition
...
- (NSTimeInterval)transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext{
    return _type == MGPresentOneTransitionTypePresent ? 0.5 : 0.25;
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    switch (_type) {
         ...
         *  Present
         */
        case MGPresentOneTransitionTypePresent:
         ...
         *  Dismiss
         */
        case MGPresentOneTransitionTypeDismiss:
